    ...
    <InfoPage title="Privacy Policy" lastUpdated="May 2026">
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1.5">
          ...
          <li><strong>Activity:</strong> purchase requests you send or receive, Looking For posts, and messages between you and other users.</li>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1.5">
          ...
          <li>To display your listings, profile, and Looking For posts to other users.</li>
