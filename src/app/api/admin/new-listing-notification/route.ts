...
export async function POST(request: Request) {
  ...
  const emailInput = makeAdminNewListingEmailInput({
    ...
    sizeEu: listing.shop_id && listing.inventory_mode === 'multi' ? inStockVariant?.size_eu ?? null : listing.size_eu,
    sizeUs: listing.shop_id && listing.inventory_mode === 'multi' ? inStockVariant?.size_us ?? null : listing.size_us,
    sizeCm: listing.shop_id && listing.inventory_mode === 'multi' ? inStockVariant?.size_cm ?? null : listing.size_cm,
    usSizeType: listing.shop_id && listing.inventory_mode === 'multi' ? inStockVariant?.us_size_type ?? null : listing.us_size_type,
